...
set firewall name iot-servers rule 5 description 'Rule: accept_k8s_ingress_from_ereaders'
set firewall name iot-servers rule 5 destination group address-group 'k8s_ingress'
set firewall name iot-servers rule 5 destination port 'http,https'
set firewall name iot-servers rule 5 protocol 'tcp'
set firewall name iot-servers rule 5 source group address-group 'ereaders'
set firewall name iot-servers rule 6 action 'accept'
set firewall name iot-servers rule 6 description 'Rule: accept_k8s_ingress_from_allowed_devices'
...
set firewall name iot-servers rule 6 source group address-group 'k8s_ingress_allowed'
set firewall name iot-servers rule 7 action 'accept'
set firewall name iot-servers rule 7 description 'Rule: accept_vector_journald_from_allowed_devices'
set firewall name iot-servers rule 7 destination group address-group 'k8s_vector_aggregator'
set firewall name iot-servers rule 7 destination port '6002'
set firewall name iot-servers rule 7 protocol 'tcp'
set firewall name iot-servers rule 7 source group address-group 'vector_journald_allowed'
set firewall name iot-servers rule 8 action 'accept'
set firewall name iot-servers rule 8 description 'Rule: accept_awnet_from_weather_stations'
set firewall name iot-servers rule 8 destination group address-group 'k8s_awnet'
set firewall name iot-servers rule 8 destination port '8080'
set firewall name iot-servers rule 8 protocol 'tcp'
set firewall name iot-servers rule 8 source group address-group 'weather_stations'
...
set firewall name local-servers rule 5 description 'Rule: accept_ntp'
set firewall name local-servers rule 5 destination port 'ntp'
set firewall name local-servers rule 5 protocol 'udp'
set firewall name local-servers rule 6 action 'accept'
set firewall name local-servers rule 6 description 'Rule: accept_mdns'
set firewall name local-servers rule 6 destination port 'mdns'
set firewall name local-servers rule 6 protocol 'udp'
...
set firewall name servers-local rule 7 description 'Rule: accept_mdns'
set firewall name servers-local rule 7 destination port 'mdns'
set firewall name servers-local rule 7 protocol 'udp'
set firewall name servers-local rule 8 action 'accept'
set firewall name servers-local rule 8 description 'Rule: accept_speedtest_exporter_from_k8s_nodes'
...
# From SERVICES to VOIP
set firewall name services-voip default-action 'drop'
set firewall name services-voip description 'From SERVICES to VOIP'
set firewall name services-voip enable-default-log
...
# From VOIP to SERVICES
set firewall name voip-services default-action 'accept'
set firewall name voip-services description 'From VOIP to SERVICES'
set firewall name voip-services rule 1 action 'accept'
set firewall name voip-services rule 1 description 'Rule: accept_dns'
set firewall name voip-services rule 1 destination port 'domain,domain-s'
set firewall name voip-services rule 1 protocol 'tcp_udp'
