...
set firewall name guest-servers rule 100 destination port '8088,8443'
...
set firewall name guest-wan rule 999 action 'drop'
set firewall name guest-wan rule 999 description 'Rule: drop_invalid'
set firewall name guest-wan rule 999 state invalid 'enable'
set firewall name guest-wan rule 999 log 'enable'
...
set firewall name iot-local rule 500 action 'accept'
set firewall name iot-local rule 500 description 'Rule: accept_icmp_from_zigbee_coordinator'
set firewall name iot-local rule 500 protocol 'icmp'
set firewall name iot-local rule 500 source group address-group 'zigbee_coordinator'
...
set firewall name iot-servers rule 600 action 'accept'
set firewall name iot-servers rule 600 description 'Rule: accept_awnet_from_weather_stations'
set firewall name iot-servers rule 600 destination group address-group 'k8s_awnet'
set firewall name iot-servers rule 600 destination port '8080'
set firewall name iot-servers rule 600 protocol 'tcp'
set firewall name iot-servers rule 600 source group address-group 'weather_stations'
...
set firewall name iot-trusted rule 100 description 'Rule: accept_scrypted_for_homekit'
set firewall name iot-trusted rule 100 protocol 'tcp_udp'
set firewall name iot-trusted rule 100 source group address-group 'scrypted'
set firewall name iot-trusted rule 100 destination group address-group 'homekit-devices'
set firewall name iot-trusted rule 110 action 'accept'
set firewall name iot-trusted rule 110 description 'Rule: accept_mdns'
set firewall name iot-trusted rule 110 destination port 'mdns'
set firewall name iot-trusted rule 110 protocol 'udp'
...
set firewall name iot-video rule 100 description 'Rule: accept_mdk8s_nodes'
...
set firewall name iot-wan rule 999 action 'drop'
set firewall name iot-wan rule 999 description 'Rule: drop_invalid'
set firewall name iot-wan rule 999 state invalid 'enable'
set firewall name iot-wan rule 999 log 'enable'
...
set firewall name lan-wan rule 999 action 'drop'
set firewall name lan-wan rule 999 description 'Rule: drop_invalid'
...
set firewall name local-servers rule 50 description 'Rule: accept_ntp'
set firewall name local-servers rule 50 destination port 'ntp'
set firewall name local-servers rule 50 protocol 'udp'
set firewall name local-servers rule 60 action 'accept'
set firewall name local-servers rule 60 description 'Rule: accept_mdns'
set firewall name local-servers rule 60 destination port 'mdns'
set firewall name local-servers rule 60 protocol 'udp'
...
set firewall name local-servers rule 120 action 'accept'
set firewall name local-servers rule 120 description 'Rule: accept_tftp_udp'
set firewall name local-servers rule 120 protocol 'udp'
...
set firewall name local-wan rule 999 action 'drop'
set firewall name local-wan rule 999 description 'Rule: drop_invalid'
...
set firewall name servers-local rule 120 action 'accept'
set firewall name servers-local rule 120 description 'Rule: accept_mdns'
set firewall name servers-local rule 120 destination port 'mdns'
set firewall name servers-local rule 120 protocol 'udp'
...
set firewall name servers-wan rule 999 action 'drop'
set firewall name servers-wan rule 999 description 'Rule: drop_invalid'
set firewall name servers-wan rule 999 state invalid 'enable'
set firewall name servers-wan rule 999 log 'enable'
...
set firewall name containers-wan rule 999 action 'drop'
set firewall name containers-wan rule 999 description 'Rule: drop_invalid'
set firewall name containers-wan rule 999 state invalid 'enable'
set firewall name containers-wan rule 999 log 'enable'
...
set firewall name trusted-servers rule 200 action 'accept'
set firewall name trusted-servers rule 200 description 'Rule: accept_plex_from_plex_clients'
set firewall name trusted-servers rule 200 destination group address-group 'k8s_plex'
set firewall name trusted-servers rule 200 destination port '32400'
set firewall name trusted-servers rule 200 protocol 'tcp'
set firewall name trusted-servers rule 200 source group address-group 'plex_clients'
...
set firewall name trusted-wan rule 999 action 'drop'
...
set firewall name video-wan rule 999 action 'drop'
set firewall name video-wan rule 999 description 'Rule: drop_invalid'
set firewall name video-wan rule 999 state invalid 'enable'
set firewall name video-wan rule 999 log 'enable'
