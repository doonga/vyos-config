...
set firewall name local-servers rule 4 description 'Rule: accept_ntp'
set firewall name local-servers rule 4 destination port 'ntp'
set firewall name local-servers rule 4 protocol 'udp'
set firewall name local-servers rule 5 action 'accept'
set firewall name local-servers rule 5 description 'Rule: accept_mdns'
set firewall name local-servers rule 5 destination port 'mdns'
