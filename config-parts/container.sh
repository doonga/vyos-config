...
set container name lego-auto image 'ghcr.io/doonga/lego-auto:v0.1.0'
...
set container name udp-broadcast-relay-mdns environment CFG_DEV value 'eth2.10;eth2.20;eth2.40;eth2.60'
