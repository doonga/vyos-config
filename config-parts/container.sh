...
# cloudflare-ddns
 ...
 set container name cloudflare-ddns image 'docker.io/favonia/cloudflare-ddns:1.8.4'
...
set container name udp-broadcast-relay-mdns environment CFG_DEV value 'eth2.20;eth2.40'
