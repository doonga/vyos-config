...
# cloudflare-ddns
 ...
 set container name cloudflare-ddns image 'docker.io/favonia/cloudflare-ddns:1.8.3'
...
set container name udp-broadcast-relay-mdns environment CFG_DEV value 'eth5.20;eth5.40'
...
set container name vector-agent volume config source '/config/containers/vector-agent/config/vector.yaml'
set container name vector-agent volume config mode 'ro'
set container name vector-agent volume data destination '/var/lib/vector'
set container name vector-agent volume data source '/config/containers/vector-agent/data'
