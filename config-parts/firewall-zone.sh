...
set firewall zone guest from voip firewall name 'voip-guest'
set firewall zone guest from wan firewall name 'wan-guest'
set firewall zone guest interface 'eth2.30'
...
set firewall zone iot from voip firewall name 'voip-iot'
set firewall zone iot from wan firewall name 'wan-iot'
set firewall zone iot interface 'eth2.40'
...
set firewall zone lan from voip firewall name 'voip-lan'
...
set firewall zone local from voip firewall name 'voip-local'
...
set firewall zone servers from voip firewall name 'voip-servers'
...
set firewall zone containers from voip firewall name 'voip-containers'
...
set firewall zone trusted from voip firewall name 'voip-trusted'
...
set firewall zone video from voip firewall name 'voip-video'
set firewall zone video from wan firewall name 'wan-video'
set firewall zone video interface 'eth2.50'

set firewall zone voip default-action 'drop'
set firewall zone voip from guest firewall name 'guest-voip'
set firewall zone voip from guest firewall name 'iot-voip'
set firewall zone voip from lan firewall name 'lan-voip'
set firewall zone voip from local firewall name 'local-voip'
set firewall zone voip from servers firewall name 'servers-voip'
set firewall zone voip from containers firewall name 'containers-voip'
set firewall zone voip from trusted firewall name 'trusted-voip'
set firewall zone voip from video firewall name 'video-voip'
set firewall zone voip from wan firewall name 'wan-voip'
set firewall zone voip interface 'eth2.60'
...
set firewall zone wan from local firewall ipv6-name 'lan-wan'
...
set firewall zone wan from voip firewall name 'voip-wan'
