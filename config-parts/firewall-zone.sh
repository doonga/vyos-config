...
set firewall zone guest interface 'eth5.30'
...
set firewall zone iot interface 'eth5.40'
...
set firewall zone ntp interface 'eth5.70'
...
set firewall zone servers interface 'eth5.10'
...
set firewall zone trusted interface 'eth5.20'
...
set firewall zone wireless interface 'eth5.60'
...
set firewall zone video interface 'eth5.50'
