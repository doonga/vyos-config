...
set firewall zone guest from ntp firewall name 'ntp-guest'
...
set firewall zone guest interface 'eth4.30'
...
set firewall zone iot from ntp firewall name 'ntp-iot'
...
set firewall zone ntp default-action 'drop'
set firewall zone ntp from guest firewall name 'guest-ntp'
set firewall zone ntp from lan firewall name 'lan-ntp'
set firewall zone ntp from iot firewall name 'iot-ntp'
set firewall zone ntp from local firewall name 'local-ntp'
set firewall zone ntp from local firewall ipv6-name "local-ntp"
set firewall zone ntp from servers firewall name 'servers-ntp'
set firewall zone ntp from containers firewall name 'containers-ntp'
set firewall zone ntp from trusted firewall name 'trusted-ntp'
set firewall zone ntp from wireless firewall name 'wireless-ntp'
set firewall zone ntp from video firewall name 'video-ntp'
set firewall zone ntp from wan firewall name 'wan-ntp'
set firewall zone ntp from wan firewall ipv6-name "wan-ntp"
set firewall zone ntp interface 'eth4.70'
...
set firewall zone local from ntp firewall name 'ntp-local'
set firewall zone local from ntp firewall ipv6-name "ntp-local"
...
set firewall zone local from trusted firewall ipv6-name 'trusted-local'
set firewall zone local from wireless firewall name 'wireless-local'
set firewall zone local from wireless firewall ipv6-name 'wireless-local'
...
set firewall zone servers from ntp firewall name 'ntp-servers'
...
set firewall zone containers from ntp firewall name 'ntp-containers'
...
set firewall zone trusted from ntp firewall name 'ntp-trusted'
set firewall zone trusted from local firewall name 'local-trusted'
set firewall zone trusted from local firewall ipv6-name 'local-trusted'
...
set firewall zone trusted from wireless firewall name 'wireless-trusted'
...
set firewall zone trusted from wan firewall ipv6-name 'wan-trusted'
...
set firewall zone wireless from ntp firewall name 'ntp-wireless'
set firewall zone wireless from local firewall name 'local-wireless'
set firewall zone wireless from local firewall ipv6-name 'local-wireless'
...
set firewall zone wireless from trusted firewall name 'trusted-wireless'
...
set firewall zone wireless from wan firewall ipv6-name 'wan-wireless'
set firewall zone wireless interface 'eth4.60'
...
set firewall zone video from ntp firewall name 'ntp-video'
...
set firewall zone video from wireless firewall name 'wireless-video'
set firewall zone video from wan firewall name 'wan-video'
set firewall zone video interface 'eth4.50'
...
set firewall zone wan from ntp firewall name 'ntp-wan'
set firewall zone wan from ntp firewall ipv6-name "ntp-wan"
...
set firewall zone wan from trusted firewall ipv6-name 'trusted-wan'
set firewall zone wan from wireless firewall name 'wireless-wan'
set firewall zone wan from wireless firewall ipv6-name 'wireless-wan'
