...
set service dhcp-server shared-network-name TRUSTED subnet 10.1.2.0/24 static-mapping homekit-utils ip-address '10.1.2.27'
set service dhcp-server shared-network-name TRUSTED subnet 10.1.2.0/24 static-mapping homekit-utils mac-address 'e0:4f:43:24:31:a4'
