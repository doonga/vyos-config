...
set service dhcp-server shared-network-name TRUSTED subnet 10.1.2.0/24 static-mapping todds-desktop ip-address '10.1.2.100'
...
set service dhcp-server shared-network-name TRUSTED subnet 10.1.2.0/24 static-mapping todds-mac-studio ip-address '10.1.2.10'
set service dhcp-server shared-network-name TRUSTED subnet 10.1.2.0/24 static-mapping todds-mac-studio mac-address '9c:76:0e:79:50:01'
set service dhcp-server shared-network-name TRUSTED subnet 10.1.2.0/24 static-mapping todds-mac-studio-wifi ip-address '10.1.2.16'
set service dhcp-server shared-network-name TRUSTED subnet 10.1.2.0/24 static-mapping todds-mac-studio-wifi mac-address '9c:76:0e:68:ee:c9'
