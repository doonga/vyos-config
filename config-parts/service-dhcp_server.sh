...
set service dhcp-server shared-network-name TRUSTED subnet 10.1.2.0/24 static-mapping todds-macbook ip-address '10.1.2.110'
...
set service dhcp-server shared-network-name VOIP subnet 10.1.5.0/24 domain-name 'private.greyrock.io'
