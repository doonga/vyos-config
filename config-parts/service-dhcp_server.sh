...
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping k8s4 mac-address '48:21:0b:3e:d8:02'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping k8s5 ip-address '10.1.3.8'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping k8s5 mac-address '48:21:0b:3e:db:da'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping k8s6 ip-address '10.1.3.9'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping k8s6 mac-address '48:21:0b:3e:d8:14'
