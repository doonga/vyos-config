...
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping light-dining-room-ceiling-1 ip-address '10.1.3.56'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping light-dining-room-ceiling-1 mac-address 'c8:c9:a3:30:33:cf'
...
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping light-dining-room-ceiling-5 mac-address 'c4:5b:be:7c:2d:29'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping light-kitchen-ceiling-1 ip-address '10.1.3.63'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping light-kitchen-ceiling-1 mac-address 'c8:c9:a3:30:2d:6b'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping light-kitchen-ceiling-2 ip-address '10.1.3.64'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping light-kitchen-ceiling-2 mac-address 'c8:c9:a3:30:28:b9'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping light-living-room-front ip-address '10.1.3.61'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping light-living-room-front mac-address 'c8:c9:a3:30:29:f6'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping light-living-room-side ip-address '10.1.3.62'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping light-living-room-side mac-address 'c8:c9:a3:30:34:f7'
