...
set service dhcp-server shared-network-name LAN subnet 10.1.0.0/24 static-mapping office-switch-8-poe ip-address '10.1.0.11'
set service dhcp-server shared-network-name LAN subnet 10.1.0.0/24 static-mapping office-switch-8-poe mac-address '78:8c:b5:ce:38:fd'
