...
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping bambu-a1-3d-printer ip-address '10.1.3.47'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping bambu-a1-3d-printer mac-address '30:30:f9:09:00:54'
...
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping game-room-ps5 ip-address '10.1.3.10'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping game-room-ps5 mac-address '78:c8:81:c3:0d:d6'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping game-room-samsung-tv-left ip-address '10.1.3.29'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping game-room-samsung-tv-left mac-address 'bc:7e:8b:79:e4:ec'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping game-room-samsung-tv-right ip-address '10.1.3.26'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping game-room-samsung-tv-right mac-address '98:06:3c:23:74:71'
...
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping light-office-ceiling-1 ip-address '10.1.3.50'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping light-office-ceiling-1 mac-address 'd8:bc:38:99:38:e5'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping light-office-ceiling-2 ip-address '10.1.3.51'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping light-office-ceiling-2 mac-address 'd8:bc:38:99:3a:1a'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping light-office-ceiling-3 ip-address '10.1.3.52'
...
set service dhcp-server shared-network-name LAN subnet 10.1.0.0/24 static-mapping game-room-u7-pro ip-address '10.1.0.22'
set service dhcp-server shared-network-name LAN subnet 10.1.0.0/24 static-mapping game-room-u7-pro mac-address '9c:05:d6:59:22:4d'
set service dhcp-server shared-network-name LAN subnet 10.1.0.0/24 static-mapping game-room-usw-flex-mini ip-address '10.1.0.16'
set service dhcp-server shared-network-name LAN subnet 10.1.0.0/24 static-mapping game-room-usw-flex-mini mac-address 'f4:e2:c6:ca:c7:58'
set service dhcp-server shared-network-name LAN subnet 10.1.0.0/24 static-mapping game-room-usw-pro-max-24-poe ip-address '10.1.0.13'
set service dhcp-server shared-network-name LAN subnet 10.1.0.0/24 static-mapping game-room-usw-pro-max-24-poe mac-address 'f4:e2:c6:ad:2a:b3'
set service dhcp-server shared-network-name LAN subnet 10.1.0.0/24 static-mapping garage-usw-pro-max-24-poe ip-address '10.1.0.14'
set service dhcp-server shared-network-name LAN subnet 10.1.0.0/24 static-mapping garage-usw-pro-max-24-poe mac-address 'f4:e2:c6:ad:2a:50'
set service dhcp-server shared-network-name LAN subnet 10.1.0.0/24 static-mapping kitchen-u7-pro ip-address '10.1.0.21'
set service dhcp-server shared-network-name LAN subnet 10.1.0.0/24 static-mapping kitchen-u7-pro mac-address '9c:05:d6:59:23:39'
set service dhcp-server shared-network-name LAN subnet 10.1.0.0/24 static-mapping living-room-usw-flex-mini ip-address '10.1.0.17'
set service dhcp-server shared-network-name LAN subnet 10.1.0.0/24 static-mapping living-room-usw-flex-mini mac-address 'f4:e2:c6:ca:c7:51'
set service dhcp-server shared-network-name LAN subnet 10.1.0.0/24 static-mapping office-usp-pdu-pro ip-address '10.1.0.31'
set service dhcp-server shared-network-name LAN subnet 10.1.0.0/24 static-mapping office-usp-pdu-pro mac-address 'd8:b3:70:5c:22:e3'
set service dhcp-server shared-network-name LAN subnet 10.1.0.0/24 static-mapping office-usw-flex-mini ip-address '10.1.0.15'
set service dhcp-server shared-network-name LAN subnet 10.1.0.0/24 static-mapping office-usw-flex-mini mac-address 'f4:e2:c6:ca:c7:88'
set service dhcp-server shared-network-name LAN subnet 10.1.0.0/24 static-mapping office-usw-pro-aggregation ip-address '10.1.0.11'
...
set service dhcp-server shared-network-name TRUSTED subnet 10.1.2.0/24 static-mapping game-room-appletv ip-address '10.1.2.13'
set service dhcp-server shared-network-name TRUSTED subnet 10.1.2.0/24 static-mapping game-room-appletv mac-address 'c0:95:6d:84:44:85'
...
set service dhcp-server shared-network-name WIRELESS subnet 10.1.5.0/24 static-mapping game-room-homepod-left ip-address '10.1.5.24'
set service dhcp-server shared-network-name WIRELESS subnet 10.1.5.0/24 static-mapping game-room-homepod-left mac-address 'ac:bc:b5:ea:0e:ef'
set service dhcp-server shared-network-name WIRELESS subnet 10.1.5.0/24 static-mapping game-room-homepod-right ip-address '10.1.5.25'
set service dhcp-server shared-network-name WIRELESS subnet 10.1.5.0/24 static-mapping game-room-homepod-right mac-address 'ac:bc:b5:e8:5e:57'
