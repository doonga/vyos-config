...
set service dhcp-server shared-network-name TRUSTED subnet 10.1.2.0/24 static-mapping todds-laptop mac-address 'f0:77:c3:5d:6a:6f'
set service dhcp-server shared-network-name TRUSTED subnet 10.1.2.0/24 static-mapping todds-surface ip-address '10.1.2.16'
set service dhcp-server shared-network-name TRUSTED subnet 10.1.2.0/24 static-mapping todds-surface mac-address '38:fc:98:0a:e8:08'
...
set service dhcp-server shared-network-name WIRELESS subnet 10.1.5.0/24 static-mapping fsr-appletv ip-address '10.1.5.25'
set service dhcp-server shared-network-name WIRELESS subnet 10.1.5.0/24 static-mapping fsr-appletv mac-address 'c0:95:6d:7a:fa:04'
set service dhcp-server shared-network-name WIRELESS subnet 10.1.5.0/24 static-mapping gameroom-appletv ip-address '10.1.5.24'
set service dhcp-server shared-network-name WIRELESS subnet 10.1.5.0/24 static-mapping gameroom-appletv mac-address 'c0:95:6d:84:44:85'
