...
set nat destination rule 104 inbound-interface name 'eth4'
...
set nat destination rule 105 inbound-interface name 'eth4.10'
...
set nat destination rule 106 inbound-interface name 'eth4.20'
...
set nat destination rule 107 inbound-interface name 'eth4.40'
...
set nat destination rule 108 inbound-interface name 'eth4.50'
...
set nat destination rule 110 inbound-interface name 'eth4.60'
