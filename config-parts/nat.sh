...
set nat destination rule 102 inbound-interface 'eth5.40'
...
set nat destination rule 103 inbound-interface 'eth5.50'
...
set nat destination rule 104 inbound-interface 'eth5'
...
set nat destination rule 105 inbound-interface 'eth5.10'
...
set nat destination rule 106 inbound-interface 'eth5.20'
...
set nat destination rule 107 inbound-interface 'eth5.40'
...
set nat destination rule 108 inbound-interface 'eth5.50'
...
set nat destination rule 110 description 'Force NTP for Wireless'
set nat destination rule 110 destination address '!10.1.5.1'
set nat destination rule 110 destination port '123'
set nat destination rule 110 inbound-interface 'eth5.60'
set nat destination rule 110 protocol 'udp'
set nat destination rule 110 translation address '10.1.5.1'
