...
set nat destination rule 102 inbound-interface 'eth2.40'
...
set nat destination rule 103 inbound-interface 'eth2.50'
...
set nat destination rule 104 inbound-interface 'eth2'
...
set nat destination rule 105 inbound-interface 'eth2.10'
...
set nat destination rule 106 inbound-interface 'eth2.20'
...
set nat destination rule 107 inbound-interface 'eth2.40'
...
set nat destination rule 108 inbound-interface 'eth2.50'
...
set nat destination rule 110 inbound-interface 'eth2.60'
